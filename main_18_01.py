from kivy.app import App  # Importa a classe App responsável por definir como uma aplicação móvel
from kivy.uix.screenmanager import ScreenManager, Screen  # Screen permite a criação de telas
...
from kivy.uix.textinput import TextInput  # Permite renderizar um objeto que recebe texto do usuário
from kivy.uix.boxlayout import BoxLayout  # Layout em caixas permite organizar os objetos na tela
